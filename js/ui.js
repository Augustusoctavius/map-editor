...
(function (global) {
  ...
  var DICT = {
    ...
    it: {
      ...
      t_sketch:'Schizzo', o_sketch:'Schizzo', h_sketch:'Un pennello a mano libera che disegna solo sui livelli che aggiungi tu. Aggiungine uno con «+ Aggiungi livello» nel pannello dei livelli, selezionalo nell’elenco, poi disegna sulla mappa.', o_hardness:'Durezza', o_sketch_eraser:'Modalità gomma', sketch_target:'Livello di destinazione', sketch_need_layer:'Aggiungi prima un tuo livello e selezionalo nell’elenco', layer_add:'+ Aggiungi livello', h_add_layer:'I livelli che aggiungi servono al disegno libero; dipingici sopra con lo strumento «Schizzo». Aggiunta ed eliminazione di livelli non sono annullabili.', layer_added:'Livello aggiunto', layer_untitled:'Livello', layer_max:'Si possono aggiungere al massimo 12 livelli utente', layer_rename:'Nome del livello', layer_rename_hint:'Doppio clic per rinominare', layer_delete:'Elimina livello', layer_delete_confirm:'Eliminare questo livello e tutto ciò che vi è disegnato? L’operazione non è annullabile.', tut_h_sketch:'Disegna a mano libera sui livelli che aggiungi tu; colore, dimensione, durezza, opacità e modalità gomma regolabili.',
    ...
    nl: {
      ...
      t_sketch:'Schets', o_sketch:'Schets', h_sketch:'Een vrije-handpenseel dat alleen tekent op lagen die je zelf toevoegt. Voeg er een toe met “+ Laag toevoegen” in het lagenpaneel, selecteer hem in de lijst en teken dan op de kaart.', o_hardness:'Hardheid', o_sketch_eraser:'Gummodus', sketch_target:'Doellaag', sketch_need_layer:'Voeg eerst je eigen laag toe en selecteer hem in de lijst', layer_add:'+ Laag toevoegen', h_add_layer:'Lagen die je zelf toevoegt zijn voor vrij tekenen; schilder erop met het gereedschap “Schets”. Lagen toevoegen en verwijderen kan niet ongedaan worden gemaakt.', layer_added:'Laag toegevoegd', layer_untitled:'Laag', layer_max:'Maximaal 12 eigen lagen', layer_rename:'Laagnaam', layer_rename_hint:'Dubbelklik om te hernoemen', layer_delete:'Laag verwijderen', layer_delete_confirm:'Deze laag en alles wat erop getekend is verwijderen? Dit kan niet ongedaan worden gemaakt.', tut_h_sketch:'Tekent uit de vrije hand op lagen die je zelf toevoegt; kleur, grootte, hardheid, dekking en een gummodus zijn instelbaar.',
      ...
      order.forEach(function (l) {
        ...
        if (l.custom) {
          ...
          del.addEventListener('click', function (e) {
            ...
            self.refreshLayers(); self.syncSketchTarget(); Cv.requestRender();
          });
          top.appendChild(del);
        }
